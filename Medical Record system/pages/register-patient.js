...
class RegisterPatient extends Component {
    ...
    render() {
        return (
            <Layout>
                <Segment padded ><h1>Create a Patient Record</h1></Segment>
                <Segment>
                ...
                <Form onSubmit={this.onSubmit} error={!!this.state.errorMessage}>
                    <Form.Group widths='equal'>
                        <Form.Field>
                            ...
                            <Input
                                placeholder = 'Eg. 0xcCc11B7444aD048F1F0fb12010a3D5853632a358'                
                                value= {this.state.ic}
                                onChange= {event => 
                        ...
                        <Form.Field>
                            ...
                            <Input
                                placeholder = 'Eg. Danul Kularathna'                        
                    ...
                    <Form.Group widths='equal'>
                        <Form.TextArea
                                label='House Address'
                                placeholder = 'Eg. 1234, Piliyanda ,Sovarapola'
                    ...
                    <Form.Group widths='equal'>
                       <Form.Field>
                            ...
                            <Input 
                                placeholder = 'Eg. Kavindu Pahasara'
